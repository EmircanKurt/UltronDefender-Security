namespace AegisPC.Contracts.Archive
{
    public class ArchiveSafetyLimits
    {
        ...
        public long MaxTotalUncompressedBytes { get; set; } = 250 * 1024 * 1024; // 250 MB max per archive
        public long MaxSingleFileUncompressedBytes { get; set; } = 100 * 1024 * 1024; // 100 MB max per file
